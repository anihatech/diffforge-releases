...
**Free desktop application for comparing files and folders — Windows & macOS**

> Compare code, configs, logs, and entire folder trees side-by-side.
> Clean dark UI. No subscription. No cloud. Runs 100% offline.
...
| **Disk** | 300 MB free space | 300 MB free space |
...
> ⚠️ On first launch macOS may say the app is from an unidentified developer.
...
2. Click the 📂 button on the **Left** side → browse and select your first file
...
- **Quick Access** sidebar: jump to Desktop, Downloads, Documents, OneDrive, etc.
- Click **▶** next to any folder to expand it
- Click a folder name to select it, then click **Select Folder**

### Compare To (Lock & Compare)
1. Open a folder comparison
2. Click **Compare To…** button in the toolbar
3. Browse to any folder — the left side stays locked while you compare different targets on the right

### Tabs
- Click **+** in the tab bar to open a new comparison session
- Each tab is independent — switch between comparisons freely
- Use **Swap** (⇄) to instantly flip left ↔ right
...
- ✅ Multi-tab interface
- ✅ Compare To — lock one side, compare against multiple folders
- ✅ Copy files between folders
- ✅ Move files to recycle bin / trash
- ✅ Expand/Collapse all folders
- ✅ Filter by Diffs / Same / Left Only / Right Only
...
DiffForge Community Edition is **free to download and use**.

> Copyright © 2025 Aniha Tech Inc. All rights reserved.
> DiffForge™ is a trademark of Aniha Tech Inc.
> See [LICENSE](LICENSE) and [NOTICE](NOTICE) for details.

Brand assets (name, logo, icon) are the exclusive property of Aniha Tech Inc
and may **not** be used, copied, or modified without written permission.
...
👉 [Open an issue](https://github.com/anihatech/diffforge-releases/issues)

---

<p align="center">
  Made with ❤️ by <strong>Aniha Tech Inc</strong>
</p>
